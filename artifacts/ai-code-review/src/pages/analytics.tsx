...
export default function Analytics() {
  ...
  const { data: trend, isLoading: trendLoading } = useGetQualityTrend({ days: 30 }, {
    query: {
      queryKey: getGetQualityTrendQueryKey({ days: 30 }),
  ...
  const { data: languages, isLoading: langLoading } = useGetLanguageBreakdown({
    query: {
